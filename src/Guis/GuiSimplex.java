...
public class GuiSimplex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtaOperaciones.setFont(new java.awt.Font("Bell MT", 1, 18)); // NOI18N
        ...
        jlPivote.setFont(new java.awt.Font("Edwardian Script ITC", 0, 36)); // NOI18N
        jlPivote.setText("Pivote");
        jPanel4.add(jlPivote);
        jlPivote.setBounds(10, 340, 180, 40);

        jlcolunna.setFont(new java.awt.Font("Edwardian Script ITC", 0, 36)); // NOI18N
        jlcolunna.setText("Columna");
        jPanel4.add(jlcolunna);
        jlcolunna.setBounds(10, 420, 150, 30);

        jlfila.setFont(new java.awt.Font("Edwardian Script ITC", 0, 36)); // NOI18N
        jlfila.setText("Fila");
        jPanel4.add(jlfila);
        jlfila.setBounds(10, 380, 130, 30);
        ...
        jScrollPane5.setBounds(20, 10, 800, 420);
        ...
        Tablon.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jScrollPane3.setBounds(10, 10, 810, 410);
        ...
        jTabbedPane1.setBounds(0, 80, 840, 480);
        //----------------------------------------------
        ...
        jButton4.setBounds(520, 10, 290, 50);
        ...
        jPanel7.setBounds(10, 10, 830, 70);
        ...
        setSize(new java.awt.Dimension(1151, 628));
